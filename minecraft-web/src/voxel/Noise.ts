// 2D & 3D Simplex / Perlin Noise Generator with fractional Brownian motion (fBm)
export class NoiseGenerator {
  ...
  // 3D Simplex Noise (-1 to 1) for cave hollows and 3D terrain density
  ...
  // Fractional Brownian Motion (fBm) over multiple octaves
